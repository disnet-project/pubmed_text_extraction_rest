 ...
 * Static Utils
 * 
 * @author Alejandro Rodr�guez Gonz�lez - Centre for Biotechnology and Plant
 *         Genomics
 *
 * PART OF THE PROJECT validation_term_extractor
 *
 */
public class StaticUtils {
	...
	/**
	 * M�todo para borrar una extensi�n en una cadena que contenga un fichero y
	 * su extensi�n.
	 * 
	 * @param name
	 *            Recibe la cadena.
	 ...
	 */
	public static LinkedList<String> getListFromArray(String[] array) {
	...
	public static int getIntPositionOf(String opt, String[] OPTS) {
		for (int i = 0; i < OPTS.length; i++) {
			if (OPTS[i].equalsIgnoreCase(opt)) return i;
		}
		return -1;
	}
}